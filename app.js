const questions = [
  ...
  "她会用内疚感来让你做你不想做的事？比如「我为你付出了这么多，你就这样对我」，或者用沉默、哭泣、生病来作为压力？",
  "她会反复提起自己的牺牲和付出，说没有她就没有你的今天，但你表达感谢的方式永远不够让她满意？",
  "她需要你不断肯定她、夸她。一旦你表达不满或者有不同意见，她会立刻崩溃、愤怒或者冷战？",
  "她会跟你说，她当年如果不是为了这个家、为了你，她本来可以有多了不起的成就，而且这句话你听过很多次？",
  "她非常在意外人怎么看你们家，不允许家里的事被外人知道，但在家里对你的方式和她对外人展示的完全是两个人？",
  "当你取得一些成绩、过得不错、或者有了自己的生活，她会泼冷水、挑毛病，或者把你的成功归功于她的培养？",
